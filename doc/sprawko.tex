...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{img/q_player_vs_q_player.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{img/q_player_vs_tree.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{img/q_player_vs_mlp.png}}
